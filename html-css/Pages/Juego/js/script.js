const MAXIMOS_INTENTOS = 35, // Intentos máximos que tiene el jugador
...
new Vue({
    ...
    data: () => ({
        ...
        imagenes: [
            ...
            "./img/etica1.jpg",
            "./img/etica2.jpg",
            "./img/informatica1.jpg",
            "./img/informatica2.jpg",
            "./img/ingles1.jpg",
            "./img/ingles2.jpg",
            "./img/artistica1.jpg",
            "./img/artistica2.jpg",
            "./img/estadistica1.jpg",
            "./img/estadistica2.jpg",
            "./img/matematicas1.jpg",
            "./img/matematicas2.jpg",
