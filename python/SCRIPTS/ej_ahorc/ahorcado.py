...
def obtener_palabra_válida(palabras):
    ...
    while '-' in palabra or ' ' in palabra or '_' in palabra or 'ñ' in palabra:
...
def ahorcado():
    ...
    abecedario = set(string.ascii_uppercase) # conjunto de letras en mayuscula del abecedario, sin contar la ñ
