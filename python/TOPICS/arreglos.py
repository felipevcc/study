...
carros.append("fresa") #append es para agregar
print(carros)

carros.pop(1) #eliminar un elemento en esa posicion, se cuenta desde 0
carros.remove("fresa")

carros[0] = "leon"
print(carros)

frutas = ['fresa', 'mora', 'manzana']
for x in frutas:
    print(x)
